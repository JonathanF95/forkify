...
const url = new URL((0, _iconsSvgDefault.default));
...
const renderSpinner = function(parentEl) {
    ...
    <div class="spinner">
          <svg>
            <use href="${fileName}#icon-loader"></use>
          </svg>
        </div>
  `;
    parentEl.innerHTML = "";
        ...
        <div class="recipe__details">
          <div class="recipe__info">
            <svg class="recipe__info-icon">
              <use href="${fileName}#icon-clock"></use>
            </svg>
          ...
          <div class="recipe__info">
            <svg class="recipe__info-icon">
              <use href="${fileName}#icon-users"></use>
            </svg>
            ...
            <div class="recipe__info-buttons">
              <button class="btn--tiny btn--increase-servings">
                <svg>
                  <use href="${fileName}#icon-minus-circle"></use>
                </svg>
              </button>
              <button class="btn--tiny btn--increase-servings">
                <svg>
                  <use href="${fileName}#icon-plus-circle"></use>
                </svg>
              </button>
            </div>
          </div>
          ...
          <div class="recipe__user-generated">
            <svg>
              <use href="${fileName}#icon-user"></use>
            </svg>
          </div>
          <button class="btn--round">
            <svg class="">
              <use href="${fileName}#icon-bookmark-fill"></use>
            </svg>
          </button>
        </div>
        ...
        <div class="recipe__directions">
          ...
          >
            ...
            <svg class="search__icon">
              <use href="${fileName}#icon-arrow-right"></use>
            </svg>
          </a>
        </div>
    `;
